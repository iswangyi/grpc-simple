...
type StreamResponse struct {
	...
	//参数类型 参数名 标识号（不可重复）
	Code        int32  `protobuf:"varint,1,opt,name=code,proto3" json:"code,omitempty"`
	StreamValue string `protobuf:"bytes,2,opt,name=stream_value,json=streamValue,proto3" json:"stream_value,omitempty"`
}

func (x *StreamResponse) Reset() {
	*x = StreamResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_serverstream_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*StreamResponse) Descriptor() ([]byte, []int) {
	return file_serverstream_proto_rawDescGZIP(), []int{2}
}
...
var file_serverstream_proto_rawDesc = []byte{
	...
	0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x22, 0x47, 0x0a, 0x0e,
	0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x12,
	0x0a, 0x04, 0x63, 0x6f, 0x64, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x05, 0x52, 0x04, 0x63, 0x6f,
	0x64, 0x65, 0x12, 0x21, 0x0a, 0x0c, 0x73, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x5f, 0x76, 0x61, 0x6c,
	0x75, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x73, 0x74, 0x72, 0x65, 0x61, 0x6d,
	0x56, 0x61, 0x6c, 0x75, 0x65, 0x32, 0x84, 0x01, 0x0a, 0x0c, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d,
	0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x12, 0x36, 0x0a, 0x05, 0x52, 0x6f, 0x75, 0x74, 0x65, 0x12,
	...
	0x72, 0x65, 0x61, 0x6d, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x3c,
	0x0a, 0x09, 0x4c, 0x69, 0x73, 0x74, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x12, 0x14, 0x2e, 0x70, 0x72,
	...
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x30, 0x01, 0x42, 0x03, 0x5a, 0x01,
...
var file_serverstream_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
...
var file_serverstream_proto_depIdxs = []int32{
	...
	2, // 2: proto.StreamServer.Route:output_type -> proto.StreamResponse
...
func file_serverstream_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_serverstream_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
...
type StreamServerClient interface {
	Route(ctx context.Context, in *SimpleRequest, opts ...grpc.CallOption) (*StreamResponse, error)
...
func (c *streamServerClient) Route(ctx context.Context, in *SimpleRequest, opts ...grpc.CallOption) (*StreamResponse, error) {
...
type StreamServerServer interface {
	Route(context.Context, *SimpleRequest) (*StreamResponse, error)
...
func (*UnimplementedStreamServerServer) Route(context.Context, *SimpleRequest) (*StreamResponse, error) {
